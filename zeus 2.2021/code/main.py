...
#        print("entering in game_state.register_move_if_needed() for main.py")
        found_move, move = game_state.register_move_if_needed()
 #       print("move found from main.py ln77" + str(found_move) )
  #      print("move is " + move)
        if found_move:
            clear_logs()
...
window.title("ChessBot ZEUS created by Yousuf")

label_titre = tk.Label(text="Welcome to my chessbot",anchor="e", wraplength = 300)#\nThis bot can not work on a game that already started")
