...
def get_chessboard(game_state):
    ...
    dim = (200, 200 ) # perform the actual resizing of the chessboard
    resizedChessBoard = cv2.resize(image, dim, interpolation = cv2.INTER_AREA)
...
def find_chessboard_from_image(img):
    ...
    if found_board:
        ...
        dim = (600, 600 ) # perform the actual resizing of the chessboard
...
def global_test_chessboard_detection():
    cleanFolder('/home/yousuf/exp/zeus bots/zeus 2.1/code/__pycache__')
